---
title: Error Types
description: "Model application errors with a structured hierarchy of LogicError, RuntimeError, and AggregateError types."
sidebar:
  order: 3
---
...
<LinkCard title="Result\<T\> Monad" description="Learn how Result uses the Error type hierarchy" href="/Monads/concepts/result-monad/" />
