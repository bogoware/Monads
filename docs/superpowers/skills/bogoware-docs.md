...
```bash
mkdir -p docs/sites/<project-name>/src/content/docs
cd docs/sites/<project-name>
```
...
- Output path: `docs/sites/<project>/src/content/docs/api/`
- Frontmatter format: `sidebar: { order: N }` instead of `sidebar_position: N`

### CI/CD (GitHub Actions)
Update `.github/workflows/docs.yml`:
- Use pnpm instead of npm
- Build command: `pnpm -C docs/sites/<project> build`
- Artifact path: `docs/sites/<project>/dist`
