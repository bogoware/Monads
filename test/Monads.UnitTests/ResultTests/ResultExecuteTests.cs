...
public class ResultExecuteTests
{
    ...
    {
        _success.IfSuccess(_inspector.Object.MethodVoid);
    ...
    {
        _success.IfFailure(_inspector.Object.MethodVoid);
    ...
    {
        _failed.IfSuccess(_inspector.Object.MethodVoid);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        _failed.IfFailure(_inspector.Object.MethodVoid);
        _inspector.Verify(i => i.MethodVoid());
    }
    ...
    {
        await _success.IfSuccess(_inspector.Object.MethodVoidAsync);
    ...
    {
        await _success.IfFailure(_inspector.Object.MethodVoidAsync);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        await _failed.IfSuccess(_inspector.Object.MethodVoidAsync);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        await _failed.IfFailure(_inspector.Object.MethodVoidAsync);
        _inspector.Verify(i => i.MethodVoidAsync());
    }
    ...
    {
        _success.IfSuccess(_inspector.Object.MethodWithValueArg);
    ...
    {
        _success.IfFailure(_inspector.Object.MethodWithErrorArg);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        _failed.IfSuccess(_inspector.Object.MethodWithValueArg);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        _failed.IfFailure(_inspector.Object.MethodWithErrorArg);
    ...
    {
        await _success.IfSuccess(_inspector.Object.MethodWithValueArgAsync);
    ...
    {
        await _success.IfFailure(_inspector.Object.MethodWithErrorArgAsync);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        await _failed.IfSuccess(_inspector.Object.MethodWithValueArgAsync);
        _inspector.VerifyNoOtherCalls();
    }
    ...
    {
        await _failed.IfFailure(_inspector.Object.MethodWithErrorArgAsync);
