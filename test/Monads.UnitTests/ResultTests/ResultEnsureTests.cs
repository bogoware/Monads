...
public class ResultEnsureTests
{
	...
	{
		var actual = _success.Ensure(value => true, new("Failed"));
	...
	{
		var actual = _success.Ensure(value => false, new("Failed"));
	...
	{
		var actual = _failed.Ensure(value => true, new("Failed"));
		actual.IsFailure.Should().BeTrue();
	}
	...
	{
		var actual = _failed.Ensure(value => false, new("Failed"));
		actual.IsFailure.Should().BeTrue();
	}
	...
	{
		var actual = await _success.Ensure(value => Task.FromResult( true), new("Failed"));
		actual.IsSuccess.Should().BeTrue();
	}
	...
	{
		var actual = await _success.Ensure(value => Task.FromResult(false), new("Failed"));
		actual.IsFailure.Should().BeTrue();
	}
	...
	{
		var actual = await _failed.Ensure(value => Task.FromResult(true), new("Failed"));
		actual.IsFailure.Should().BeTrue();
	}
	...
	{
		var actual = await _failed.Ensure(value => Task.FromResult(false), new("Failed"));
		actual.IsFailure.Should().BeTrue();
	}
